...
export default function NotesHeader({ onAddNotes, editingNote, handleUpdateNote }) {
...
useEffect(() => {
  ...
  return (
    ...
    style={{ background: "#343a40", color: "white" }} data-toggle="modal" data-target="#exampleModal" 
    onClick={handleSetModal}>
  <i className="bi-plus"></i> <span className="text-white">Create Note</span>
</button>
